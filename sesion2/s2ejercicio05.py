...
"""Separo la cadena introducida en una lista con tres elementos: hora, minuto y segundo"""
...
"""Calculo la diferencia entre las horas, minutos y segundos"""
...
print("La diferencia entre las dos horas es: ", abs(dif_horas), ":",
      abs(dif_minutos), ":", abs(dif_segundos))
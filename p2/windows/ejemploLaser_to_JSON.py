...
_, robothandle = sim.simxGetObjectHandle(clientID, 'Pioneer_p3dx', sim.simx_opmode_oneshot_wait)
...
_, datosLaserComp = sim.simxGetStringSignal(clientID,'LaserData',sim.simx_opmode_streaming)
...
_, personhandle = sim.simxGetObjectHandle(clientID, 'Bill', sim.simx_opmode_oneshot_wait)
...
while(iteracion<=maxIter and seguir):
    ...
    returnCode = sim.simxSetObjectPosition(clientID,personhandle,-1,[1+2.0*iteracion/10,-0.4,0.0],sim.simx_opmode_oneshot)
    ...
    returnCode = sim.simxSetObjectOrientation(clientID, personhandle, -1, [0.0,0.0,3.05-(0.20)*iteracion], sim.simx_opmode_oneshot)
    ...
    puntosy=[]
    puntosz=[]
    returnCode, signalValue = sim.simxGetStringSignal(clientID,'LaserData',sim.simx_opmode_buffer) 
   
    datosLaser=sim.simxUnpackFloats(signalValue)
...
orientacionRobot=sim.simxGetObjectOrientation(clientID, robothandle, -1, sim.simx_opmode_oneshot_wait)

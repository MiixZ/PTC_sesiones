# -*- coding: utf-8 -*-
"""
ESTO ES UN EJEMPLO DE VALIDACIÓN DE ENTRADAS USANDO EXCEPCIONES
@author: Eugenio
...
entradasCorrec_a_leer = 4  # pedir 4 valores correctos. Funcionará hasta que lea 4 valores correctos.
entradasCorrectas = 0
